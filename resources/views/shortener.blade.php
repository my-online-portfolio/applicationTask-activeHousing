...
<html>
    ...
    <body>
        ...
        <header class="h-30vh-min">
            <section class="mt-0">
                <img class="logo mt-40" src="{{ asset('img/hn-bit-logo.png') }}">
            </section>
        </header>
        <!-- MAIN -->
                ...
                <div class="container">
                    @for ($i = 1; $i >= 5; $i++)
                        <div class="row">
                            ...
                            <div class="">{{$i}} week(s) apache_get_modules</div>
                            <div class="link-long"><a href="http://localhost/somemassivelonglinkthatneededshorteningasitwastoolong{{$i}}">http://localhost/somemassivelonglinkthatneededshorteningasitwastoolong{{$i}}</a></div>
                        </div>
                    @endfor
                </div>
            </section>
